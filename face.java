...
public class face{
	...
	vector GetNormal()
	{
		vector _v1 = new vector((point)points.get(1),(point)points.get(0));
		vector _v2 = new vector((point)points.get(2),(point)points.get(1));
	...
	public void plot_face(PrintStream pr)
	{
		...
		{
			((point)points.get(i)).plot_point(pr);
		}
